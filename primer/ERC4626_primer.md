...
- [ ] Interest accrued matches time _ rate _ principal
...
6. IDs include signer identity, not just signature
7. Expected signer matches actual depositor/actor
8. Malicious contracts cannot grief legitimate operations
9. Cost of griefing attack exceeds potential damage
10. Smart Contract Wallet Testing: Always test protocols with major SC wallet implementations (Safe, Argent) using both threshold signatures and approved hashes
